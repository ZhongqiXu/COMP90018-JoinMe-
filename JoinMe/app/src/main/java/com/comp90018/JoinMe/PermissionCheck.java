    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_permission.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Dexter.withActivity(PermissionCheck.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionDenied(PermissionDeniedResponse permissionDeniedResponse) {
                                if(permissionDeniedResponse.isPermanentlyDenied()) {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(PermissionCheck.this);
                                    builder.setTitle("Permission denied!").setMessage("Permission to access device location is permanently denied. You need to go to the settings to allow the permission.")
                                    ...
                                    Toast.makeText(PermissionCheck.this, "Permission denied", Toast.LENGTH_SHORT);
                                }
                            }
